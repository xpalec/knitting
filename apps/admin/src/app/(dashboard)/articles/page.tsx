    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <StatCard
          ...
          value={summaryQueries[0].data?.meta?.total ?? '—'}
        ...
        <StatCard
          ...
          value={summaryQueries[1].data?.meta?.total ?? '—'}
          label="Published"
        ...
        <StatCard
          ...
          value={summaryQueries[2].data?.meta?.total ?? '—'}
          label="Drafts"
        ...
        <StatCard
          ...
          value={summaryQueries[3].data?.meta?.total ?? '—'}
          label="In review"
